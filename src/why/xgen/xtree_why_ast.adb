   ...
   begin
      ...
      begin
         ...
         for I in Vars'Range loop
            ...
            PL (O, " -> " & OCaml_Upper_Identifier (To_String (Vars (I))));
         end loop;
